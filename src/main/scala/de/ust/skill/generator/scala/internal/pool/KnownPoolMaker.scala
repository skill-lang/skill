 ...
 * @author Timm Felden
 */
abstract class KnownPool[T <: B, B <: KnownType](poolIndex:Long, name: String, fields: HashMap[String, FieldDeclaration], _superPool: Option[AbstractPool])
    extends AbstractPool(poolIndex:Long, name, fields, _superPool)
    with Iterable[T] {
