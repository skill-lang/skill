...
trait GeneralOutputMaker extends Generator {
  ...
  override def getLanguageName : String = "csharp";
  ...
  val ArrayTypeName = "System.Collections.ArrayList"
  val VarArrayTypeName = "System.Collections.ArrayList"
  val ListTypeName = "System.Collections.Generic.List"
  val SetTypeName = "System.Collections.Generic.HashSet"
  val MapTypeName = "System.Collections.Generic.Dictionary"
  ...
  protected final def interfacePool(t : InterfaceType) : String =
    if (t.getSuperType.getSkillName.equals("annotation"))
      s"de.ust.skill.common.csharp.@internal.UnrootedInterfacePool<${mapType(t)}>"
    else
      s"de.ust.skill.common.csharp.@internal.InterfacePool<SkillObject, ${mapType(t.getBaseType)}>"
