...
final class KnownField_InterfaceType_super(
  ...
  override def setR(i : SkillObject, v : _root_.de.ust.skill.sir.ClassType) {
    i.asInstanceOf[_root_.de.ust.skill.sir.InterfaceType].`super` = v.asInstanceOf[_root_.de.ust.skill.sir.ClassType]
  }
}
