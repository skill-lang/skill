...
final class KnownField_BuildInformation_language(
  ...
  _type : FieldType[java.lang.String])
    extends KnownField[java.lang.String,_root_.de.ust.skill.sir.BuildInformation](_type,
      "language",
      _index,
      _owner) {
  ...
  //override def get(i : _root_.de.ust.skill.sir.BuildInformation) = i.language
  //override def set(i : _root_.de.ust.skill.sir.BuildInformation, v : java.lang.String) = i.language = v.asInstanceOf[java.lang.String]
  ...
  override def setR(i : SkillObject, v : java.lang.String) : Unit = i.asInstanceOf[_root_.de.ust.skill.sir.BuildInformation].language = v.asInstanceOf[java.lang.String]
}
