 ...
 */
final class KnownField_CommentTag_text(
  _index : Int,
  _owner : CommentTagPool,
  _type : FieldType[scala.collection.mutable.ArrayBuffer[java.lang.String]])
    extends FieldDeclaration[scala.collection.mutable.ArrayBuffer[java.lang.String],_root_.de.ust.skill.sir.CommentTag](_type,
      "text",
      _index,
      _owner)
    ...
    try {
        target match {
          case c : SimpleChunk ⇒
            ...
            val high = i + c.count
            while (i != high) {
              d(i).asInstanceOf[_root_.de.ust.skill.sir.CommentTag].Internal_text = t.read(in).asInstanceOf[scala.collection.mutable.ArrayBuffer[java.lang.String]]
              i += 1
            }
          case bci : BulkChunk ⇒
  ...
  def offset: Unit = {
    ...
    dataChunks.last match {
      case c : SimpleChunk ⇒
        ...
        val high = i + c.count
        while (i != high) {
          val v = data(i).asInstanceOf[_root_.de.ust.skill.sir.CommentTag].Internal_text
