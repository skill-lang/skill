...
final class KnownField_ToolTypeCustomization_restrictions(
  ...
  _type : FieldType[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Restriction]])
    extends KnownField[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Restriction],_root_.de.ust.skill.sir.ToolTypeCustomization](_type,
      "restrictions",
      _index,
      _owner) {
  ...
  //override def get(i : _root_.de.ust.skill.sir.ToolTypeCustomization) = i.restrictions
  //override def set(i : _root_.de.ust.skill.sir.ToolTypeCustomization, v : scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Restriction]) = i.restrictions = v.asInstanceOf[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Restriction]]
  ...
  override def setR(i : SkillObject, v : scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Restriction]) : Unit = i.asInstanceOf[_root_.de.ust.skill.sir.ToolTypeCustomization].restrictions = v.asInstanceOf[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Restriction]]
}
