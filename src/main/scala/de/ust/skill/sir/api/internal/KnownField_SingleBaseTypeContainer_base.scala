 ...
 */
final class KnownField_SingleBaseTypeContainer_base(
  _index : Int,
  _owner : SingleBaseTypeContainerPool,
  _type : FieldType[_root_.de.ust.skill.sir.GroundType])
    extends FieldDeclaration[_root_.de.ust.skill.sir.GroundType,_root_.de.ust.skill.sir.SingleBaseTypeContainer](_type,
      "base",
      _index,
      _owner)
    with KnownField[_root_.de.ust.skill.sir.GroundType,_root_.de.ust.skill.sir.SingleBaseTypeContainer] {
    ...
    try {
        target match {
          case c : SimpleChunk ⇒
            ...
            val high = i + c.count
            while (i != high) {
              d(i).asInstanceOf[_root_.de.ust.skill.sir.SingleBaseTypeContainer].Internal_base = t.read(in).asInstanceOf[_root_.de.ust.skill.sir.GroundType]
              i += 1
            }
          case bci : BulkChunk ⇒
  ...
  def offset: Unit = {
    ...
    dataChunks.last match {
      case c : SimpleChunk ⇒
        ...
        val high = i + c.count
        while (i != high) {
          val v = data(i).asInstanceOf[_root_.de.ust.skill.sir.SingleBaseTypeContainer].Internal_base
  ...
  //override def get(i : _root_.de.ust.skill.sir.SingleBaseTypeContainer) = i.base
  //override def set(i : _root_.de.ust.skill.sir.SingleBaseTypeContainer, v : _root_.de.ust.skill.sir.Type) = i.base = v.asInstanceOf[_root_.de.ust.skill.sir.GroundType]

  // note: reflective field access will raise exception for ignored fields
  override def getR(i : SkillObject) : _root_.de.ust.skill.sir.GroundType = i.asInstanceOf[_root_.de.ust.skill.sir.SingleBaseTypeContainer].base
  override def setR(i : SkillObject, v : _root_.de.ust.skill.sir.GroundType) : Unit = i.asInstanceOf[_root_.de.ust.skill.sir.SingleBaseTypeContainer].base = v.asInstanceOf[_root_.de.ust.skill.sir.GroundType]
}
