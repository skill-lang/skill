...
final class KnownField_InterfaceType_fields(
  ...
  override def setR(i : SkillObject, v : scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.FieldLike]) {
    i.asInstanceOf[_root_.de.ust.skill.sir.InterfaceType].fields = v.asInstanceOf[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.FieldLike]]
  }
}
