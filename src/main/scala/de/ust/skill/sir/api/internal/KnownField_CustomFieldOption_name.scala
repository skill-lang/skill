 ...
 */
final class KnownField_CustomFieldOption_name(
  _index : Int,
  _owner : CustomFieldOptionPool,
  _type : FieldType[java.lang.String])
    extends KnownField[java.lang.String,_root_.de.ust.skill.sir.CustomFieldOption](_type,
      "name",
      _index,
      _owner) {
  ...
  //override def get(i : _root_.de.ust.skill.sir.CustomFieldOption) = i.name
  //override def set(i : _root_.de.ust.skill.sir.CustomFieldOption, v : java.lang.String) = i.name = v.asInstanceOf[java.lang.String]
  ...
  override def setR(i : SkillObject, v : java.lang.String) : Unit = i.asInstanceOf[_root_.de.ust.skill.sir.CustomFieldOption].name = v.asInstanceOf[java.lang.String]
}
