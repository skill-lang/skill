 ...
 */
final class KnownField_Restriction_arguments(
  _index : Int,
  _owner : RestrictionPool,
  _type : FieldType[scala.collection.mutable.ArrayBuffer[java.lang.String]])
    extends FieldDeclaration[scala.collection.mutable.ArrayBuffer[java.lang.String],_root_.de.ust.skill.sir.Restriction](_type,
      "arguments",
      _index,
      _owner)
    with KnownField[scala.collection.mutable.ArrayBuffer[java.lang.String],_root_.de.ust.skill.sir.Restriction] {
    ...
    try {
        target match {
          case c : SimpleChunk ⇒
            ...
            val high = i + c.count
            while (i != high) {
              d(i).asInstanceOf[_root_.de.ust.skill.sir.Restriction].Internal_arguments = t.read(in).asInstanceOf[scala.collection.mutable.ArrayBuffer[java.lang.String]]
              i += 1
            }
          case bci : BulkChunk ⇒
  ...
  def offset: Unit = {
    ...
    dataChunks.last match {
      case c : SimpleChunk ⇒
        ...
        val high = i + c.count
        while (i != high) {
          val v = data(i).asInstanceOf[_root_.de.ust.skill.sir.Restriction].Internal_arguments
  ...
  //override def get(i : _root_.de.ust.skill.sir.Restriction) = i.arguments
  //override def set(i : _root_.de.ust.skill.sir.Restriction, v : scala.collection.mutable.ArrayBuffer[java.lang.String]) = i.arguments = v.asInstanceOf[scala.collection.mutable.ArrayBuffer[java.lang.String]]

  // note: reflective field access will raise exception for ignored fields
  override def getR(i : SkillObject) : scala.collection.mutable.ArrayBuffer[java.lang.String] = i.asInstanceOf[_root_.de.ust.skill.sir.Restriction].arguments
  override def setR(i : SkillObject, v : scala.collection.mutable.ArrayBuffer[java.lang.String]) : Unit = i.asInstanceOf[_root_.de.ust.skill.sir.Restriction].arguments = v.asInstanceOf[scala.collection.mutable.ArrayBuffer[java.lang.String]]
}
