...
/**
 * restriction[] FieldLike.restrictions
 */
final class KnownField_FieldLike_restrictions(
  _index : Int,
  _owner : FieldLikePool,
  _type : FieldType[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Restriction]])
    extends FieldDeclaration[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Restriction],_root_.de.ust.skill.sir.FieldLike](_type,
      "restrictions",
      _index,
      _owner)
    with KnownField[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Restriction],_root_.de.ust.skill.sir.FieldLike] {
    ...
    try {
        target match {
          case c : SimpleChunk ⇒
            ...
            val high = i + c.count
            while (i != high) {
              d(i).asInstanceOf[_root_.de.ust.skill.sir.FieldLike].Internal_restrictions = t.read(in).asInstanceOf[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Restriction]]
              i += 1
            }
          case bci : BulkChunk ⇒
  ...
  def offset: Unit = {
    ...
    dataChunks.last match {
      case c : SimpleChunk ⇒
        ...
        val high = i + c.count
        while (i != high) {
          val v = data(i).asInstanceOf[_root_.de.ust.skill.sir.FieldLike].Internal_restrictions
  ...
  //override def get(i : _root_.de.ust.skill.sir.FieldLike) = i.restrictions
  //override def set(i : _root_.de.ust.skill.sir.FieldLike, v : scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Restriction]) = i.restrictions = v.asInstanceOf[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Restriction]]

  // note: reflective field access will raise exception for ignored fields
  override def getR(i : SkillObject) : scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Restriction] = i.asInstanceOf[_root_.de.ust.skill.sir.FieldLike].restrictions
  override def setR(i : SkillObject, v : scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Restriction]) : Unit = i.asInstanceOf[_root_.de.ust.skill.sir.FieldLike].restrictions = v.asInstanceOf[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Restriction]]
}
