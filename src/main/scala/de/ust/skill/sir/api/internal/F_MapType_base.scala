 ...
 * type[] MapType.base
 */
final class F_MapType_base(
  _index : Int,
  _owner : MapTypePool,
  _type : FieldType[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.GroundType]])
    extends FieldDeclaration[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.GroundType],_root_.de.ust.skill.sir.MapType](_type,
      "base",
      _index,
      _owner)
    with KnownField[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.GroundType],_root_.de.ust.skill.sir.MapType] {
  ...
  override def check : Unit = {
    ...
    while (xs.hasNext) {
      val x = xs.next
      val ref = getR(x)
      if (ref!=null && !ref.isInstanceOf[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.GroundType]]) {
        throw RestrictionCheckFailed(s"""$ref is not an instance of interface scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.GroundType]
 In: $x.base
 Actual type: ${ref.getClass}""")
  ...
  override def setR(i : SkillObject, v : scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.GroundType]) {
    i.asInstanceOf[_root_.de.ust.skill.sir.MapType].base = v.asInstanceOf[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.GroundType]]
  }
}
