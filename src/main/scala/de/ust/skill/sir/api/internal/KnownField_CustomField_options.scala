...
final class KnownField_CustomField_options(
  ...
  override def setR(i : SkillObject, v : scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.CustomFieldOption]) {
    i.asInstanceOf[_root_.de.ust.skill.sir.CustomField].options = v.asInstanceOf[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.CustomFieldOption]]
  }
}
