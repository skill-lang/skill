 ...
 */
final class KnownField_Comment_tags(
  _index : Int,
  _owner : CommentPool,
  _type : FieldType[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.CommentTag]])
    extends FieldDeclaration[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.CommentTag],_root_.de.ust.skill.sir.Comment](_type,
      "tags",
      _index,
      _owner)
    with KnownField[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.CommentTag],_root_.de.ust.skill.sir.Comment] {
    ...
    try {
        target match {
          case c : SimpleChunk ⇒
            ...
            val high = i + c.count
            while (i != high) {
              d(i).asInstanceOf[_root_.de.ust.skill.sir.Comment].Internal_tags = t.read(in).asInstanceOf[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.CommentTag]]
              i += 1
            }
          case bci : BulkChunk ⇒
  ...
  def offset: Unit = {
    ...
    dataChunks.last match {
      case c : SimpleChunk ⇒
        ...
        val high = i + c.count
        while (i != high) {
          val v = data(i).asInstanceOf[_root_.de.ust.skill.sir.Comment].Internal_tags
  ...
  //override def get(i : _root_.de.ust.skill.sir.Comment) = i.tags
  //override def set(i : _root_.de.ust.skill.sir.Comment, v : scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.CommentTag]) = i.tags = v.asInstanceOf[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.CommentTag]]

  // note: reflective field access will raise exception for ignored fields
  override def getR(i : SkillObject) : scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.CommentTag] = i.asInstanceOf[_root_.de.ust.skill.sir.Comment].tags
  override def setR(i : SkillObject, v : scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.CommentTag]) : Unit = i.asInstanceOf[_root_.de.ust.skill.sir.Comment].tags = v.asInstanceOf[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.CommentTag]]
}
