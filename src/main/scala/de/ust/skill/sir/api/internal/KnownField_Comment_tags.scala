...
final class KnownField_Comment_tags(
  ...
  override def setR(i : SkillObject, v : scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.CommentTag]) {
    i.asInstanceOf[_root_.de.ust.skill.sir.Comment].tags = v.asInstanceOf[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.CommentTag]]
  }
}
