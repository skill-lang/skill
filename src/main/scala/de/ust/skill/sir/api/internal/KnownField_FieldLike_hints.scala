 ...
 */
final class KnownField_FieldLike_hints(
  _index : Int,
    ...
    try {
        target match {
          case c : SimpleChunk ⇒
            ...
            val high = i + c.count
            while (i != high) {
              d(i).asInstanceOf[_root_.de.ust.skill.sir.FieldLike].Internal_hints = t.read(in).asInstanceOf[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Hint]]
              i += 1
            }
          case bci : BulkChunk ⇒
  ...
  def offset: Unit = {
    ...
    dataChunks.last match {
      case c : SimpleChunk ⇒
        ...
        val high = i + c.count
        while (i != high) {
          val v = data(i).asInstanceOf[_root_.de.ust.skill.sir.FieldLike].Internal_hints
  ...
  //override def get(i : _root_.de.ust.skill.sir.FieldLike) = i.hints
  //override def set(i : _root_.de.ust.skill.sir.FieldLike, v : scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Hint]) = i.hints = v.asInstanceOf[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Hint]]

  // note: reflective field access will raise exception for ignored fields
  override def getR(i : SkillObject) : scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Hint] = i.asInstanceOf[_root_.de.ust.skill.sir.FieldLike].hints
  override def setR(i : SkillObject, v : scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Hint]) : Unit = i.asInstanceOf[_root_.de.ust.skill.sir.FieldLike].hints = v.asInstanceOf[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Hint]]
}
