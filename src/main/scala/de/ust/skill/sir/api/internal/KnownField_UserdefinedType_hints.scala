 ...
 */
final class KnownField_UserdefinedType_hints(
  _index : Int,
  _owner : UserdefinedTypePool,
  _type : FieldType[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Hint]])
    extends KnownField[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Hint],_root_.de.ust.skill.sir.UserdefinedType](_type,
      "hints",
      _index,
      _owner) {
  ...
  //override def get(i : _root_.de.ust.skill.sir.UserdefinedType) = i.hints
  //override def set(i : _root_.de.ust.skill.sir.UserdefinedType, v : scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Hint]) = i.hints = v.asInstanceOf[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Hint]]
  ...
  override def setR(i : SkillObject, v : scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Hint]) : Unit = i.asInstanceOf[_root_.de.ust.skill.sir.UserdefinedType].hints = v.asInstanceOf[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Hint]]
}
