...
final class KnownField_Tool_selectedFields(
  ...
  _type : FieldType[scala.collection.mutable.HashMap[_root_.de.ust.skill.sir.UserdefinedType, scala.collection.mutable.HashMap[java.lang.String, _root_.de.ust.skill.sir.FieldLike]]])
    extends KnownField[scala.collection.mutable.HashMap[_root_.de.ust.skill.sir.UserdefinedType, scala.collection.mutable.HashMap[java.lang.String, _root_.de.ust.skill.sir.FieldLike]],_root_.de.ust.skill.sir.Tool](_type,
      "selectedfields",
      _index,
      _owner) {
