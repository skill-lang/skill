...
/**
 * string[] FieldLike.nameParts
 */
final class KnownField_FieldLike_nameParts(
  _index : Int,
  _owner : FieldLikePool,
  _type : FieldType[scala.collection.mutable.ArrayBuffer[java.lang.String]])
    extends KnownField[scala.collection.mutable.ArrayBuffer[java.lang.String],_root_.de.ust.skill.sir.FieldLike](_type,
      "nameparts",
      _index,
      _owner) {
    ...
    try {
        target match {
          case c : SimpleChunk ⇒
            ...
            val high = i + c.count
            while (i != high) {
              d(i).asInstanceOf[_root_.de.ust.skill.sir.FieldLike].Internal_nameParts = t.read(in).asInstanceOf[scala.collection.mutable.ArrayBuffer[java.lang.String]]
              i += 1
            }
          case bci : BulkChunk ⇒
  ...
  def offset: Unit = {
    ...
    dataChunks.last match {
      case c : SimpleChunk ⇒
        ...
        val high = i + c.count
        while (i != high) {
          val v = data(i).asInstanceOf[_root_.de.ust.skill.sir.FieldLike].Internal_nameParts
  ...
  //override def get(i : _root_.de.ust.skill.sir.FieldLike) = i.nameParts
  //override def set(i : _root_.de.ust.skill.sir.FieldLike, v : scala.collection.mutable.ArrayBuffer[java.lang.String]) = i.nameParts = v.asInstanceOf[scala.collection.mutable.ArrayBuffer[java.lang.String]]

  // note: reflective field access will raise exception for ignored fields
  override def getR(i : SkillObject) : scala.collection.mutable.ArrayBuffer[java.lang.String] = i.asInstanceOf[_root_.de.ust.skill.sir.FieldLike].nameParts
  override def setR(i : SkillObject, v : scala.collection.mutable.ArrayBuffer[java.lang.String]) : Unit = i.asInstanceOf[_root_.de.ust.skill.sir.FieldLike].nameParts = v.asInstanceOf[scala.collection.mutable.ArrayBuffer[java.lang.String]]
}
