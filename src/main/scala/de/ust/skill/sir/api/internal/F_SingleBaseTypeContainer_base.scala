 ...
 */
final class F_SingleBaseTypeContainer_base(
  _index : Int,
  ...
  override def check : Unit = {
    ...
    while (xs.hasNext) {
      val x = xs.next
      val ref = getR(x)
      if (ref!=null && !ref.isInstanceOf[_root_.de.ust.skill.sir.GroundType]) {
        throw RestrictionCheckFailed(s"""$ref is not an instance of interface _root_.de.ust.skill.sir.GroundType
 In: $x.base
 Actual type: ${ref.getClass}""")
  ...
  override def setR(i : SkillObject, v : _root_.de.ust.skill.sir.GroundType) {
    i.asInstanceOf[_root_.de.ust.skill.sir.SingleBaseTypeContainer].base = v.asInstanceOf[_root_.de.ust.skill.sir.GroundType]
  }
}
