 ...
 */
final class KnownField_Restriction_name(
  _index : Int,
  _owner : RestrictionPool,
  _type : FieldType[java.lang.String])
    extends FieldDeclaration[java.lang.String,_root_.de.ust.skill.sir.Restriction](_type,
      "name",
      _index,
      _owner)
    with KnownField[java.lang.String,_root_.de.ust.skill.sir.Restriction] {
    ...
    try {
        target match {
          case c : SimpleChunk ⇒
            ...
            val high = i + c.count
            while (i != high) {
              d(i).asInstanceOf[_root_.de.ust.skill.sir.Restriction].Internal_name = t.read(in).asInstanceOf[java.lang.String]
              i += 1
            }
          case bci : BulkChunk ⇒
  ...
  def offset: Unit = {
    ...
    dataChunks.last match {
      case c : SimpleChunk ⇒
        ...
        val high = i + c.count
        while (i != high) {
          val v = data(i).asInstanceOf[_root_.de.ust.skill.sir.Restriction].Internal_name
          result += t.offset(v)
          i += 1
        }
      case bci : BulkChunk ⇒
  ...
  //override def get(i : _root_.de.ust.skill.sir.Restriction) = i.name
  //override def set(i : _root_.de.ust.skill.sir.Restriction, v : java.lang.String) = i.name = v.asInstanceOf[java.lang.String]

  // note: reflective field access will raise exception for ignored fields
  override def getR(i : SkillObject) : java.lang.String = i.asInstanceOf[_root_.de.ust.skill.sir.Restriction].name
  override def setR(i : SkillObject, v : java.lang.String) : Unit = i.asInstanceOf[_root_.de.ust.skill.sir.Restriction].name = v.asInstanceOf[java.lang.String]
}
