 ...
 */
final class KnownField_Tool_customTypeAnnotations(
  _index : Int,
  _owner : ToolPool,
  _type : FieldType[scala.collection.mutable.HashMap[_root_.de.ust.skill.sir.UserdefinedType, _root_.de.ust.skill.sir.ToolTypeCustomization]])
    extends FieldDeclaration[scala.collection.mutable.HashMap[_root_.de.ust.skill.sir.UserdefinedType, _root_.de.ust.skill.sir.ToolTypeCustomization],_root_.de.ust.skill.sir.Tool](_type,
    ...
    try {
        target match {
          case c : SimpleChunk ⇒
            ...
            val high = i + c.count
            while (i != high) {
              d(i).asInstanceOf[_root_.de.ust.skill.sir.Tool].Internal_customTypeAnnotations = t.read(in).asInstanceOf[scala.collection.mutable.HashMap[_root_.de.ust.skill.sir.UserdefinedType, _root_.de.ust.skill.sir.ToolTypeCustomization]]
              i += 1
            }
          case bci : BulkChunk ⇒
  ...
  def offset: Unit = {
    ...
    dataChunks.last match {
      case c : SimpleChunk ⇒
        ...
        val high = i + c.count
        while (i != high) {
          val v = data(i).asInstanceOf[_root_.de.ust.skill.sir.Tool].Internal_customTypeAnnotations
