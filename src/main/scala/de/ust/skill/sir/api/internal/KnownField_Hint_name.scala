 ...
 * string Hint.name
 */
final class KnownField_Hint_name(
  _index : Int,
  _owner : HintPool,
  _type : FieldType[java.lang.String])
    extends FieldDeclaration[java.lang.String,_root_.de.ust.skill.sir.Hint](_type,
      "name",
      _index,
      _owner)
    with KnownField[java.lang.String,_root_.de.ust.skill.sir.Hint] {
    ...
    try {
        target match {
          case c : SimpleChunk ⇒
            ...
            val high = i + c.count
            while (i != high) {
              d(i).asInstanceOf[_root_.de.ust.skill.sir.Hint].Internal_name = t.read(in).asInstanceOf[java.lang.String]
              i += 1
            }
          case bci : BulkChunk ⇒
  ...
  def offset: Unit = {
    ...
    dataChunks.last match {
      case c : SimpleChunk ⇒
        ...
        val high = i + c.count
        while (i != high) {
          val v = data(i).asInstanceOf[_root_.de.ust.skill.sir.Hint].Internal_name
          result += t.offset(v)
          i += 1
        }
      case bci : BulkChunk ⇒
  ...
  //override def get(i : _root_.de.ust.skill.sir.Hint) = i.name
  //override def set(i : _root_.de.ust.skill.sir.Hint, v : java.lang.String) = i.name = v.asInstanceOf[java.lang.String]

  // note: reflective field access will raise exception for ignored fields
  override def getR(i : SkillObject) : java.lang.String = i.asInstanceOf[_root_.de.ust.skill.sir.Hint].name
  override def setR(i : SkillObject, v : java.lang.String) : Unit = i.asInstanceOf[_root_.de.ust.skill.sir.Hint].name = v.asInstanceOf[java.lang.String]
}
