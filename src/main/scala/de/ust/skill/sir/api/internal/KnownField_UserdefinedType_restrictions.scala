...
final class KnownField_UserdefinedType_restrictions(
  ...
  override def setR(i : SkillObject, v : scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Restriction]) {
    i.asInstanceOf[_root_.de.ust.skill.sir.UserdefinedType].restrictions = v.asInstanceOf[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Restriction]]
  }
}
