...
/**
 * string[] BuildInformation.options
 */
final class KnownField_BuildInformation_options(
  _index : Int,
  _owner : BuildInformationPool,
  _type : FieldType[scala.collection.mutable.ArrayBuffer[java.lang.String]])
    extends FieldDeclaration[scala.collection.mutable.ArrayBuffer[java.lang.String],_root_.de.ust.skill.sir.BuildInformation](_type,
      "options",
      _index,
      _owner)
    with KnownField[scala.collection.mutable.ArrayBuffer[java.lang.String],_root_.de.ust.skill.sir.BuildInformation] {
    ...
    try {
        target match {
          case c : SimpleChunk ⇒
            ...
            val high = i + c.count
            while (i != high) {
              d(i).asInstanceOf[_root_.de.ust.skill.sir.BuildInformation].Internal_options = t.read(in).asInstanceOf[scala.collection.mutable.ArrayBuffer[java.lang.String]]
              i += 1
            }
          case bci : BulkChunk ⇒
  ...
  def offset: Unit = {
    ...
    dataChunks.last match {
      case c : SimpleChunk ⇒
        ...
        val high = i + c.count
        while (i != high) {
          val v = data(i).asInstanceOf[_root_.de.ust.skill.sir.BuildInformation].Internal_options
  ...
  //override def get(i : _root_.de.ust.skill.sir.BuildInformation) = i.options
  //override def set(i : _root_.de.ust.skill.sir.BuildInformation, v : scala.collection.mutable.ArrayBuffer[java.lang.String]) = i.options = v.asInstanceOf[scala.collection.mutable.ArrayBuffer[java.lang.String]]

  // note: reflective field access will raise exception for ignored fields
  override def getR(i : SkillObject) : scala.collection.mutable.ArrayBuffer[java.lang.String] = i.asInstanceOf[_root_.de.ust.skill.sir.BuildInformation].options
  override def setR(i : SkillObject, v : scala.collection.mutable.ArrayBuffer[java.lang.String]) : Unit = i.asInstanceOf[_root_.de.ust.skill.sir.BuildInformation].options = v.asInstanceOf[scala.collection.mutable.ArrayBuffer[java.lang.String]]
}
