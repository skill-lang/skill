...
/**
 * string SingleBaseTypeContainer.kind
 */
final class KnownField_SingleBaseTypeContainer_kind(
  _index : Int,
  _owner : SingleBaseTypeContainerPool,
  _type : FieldType[java.lang.String])
    extends FieldDeclaration[java.lang.String,_root_.de.ust.skill.sir.SingleBaseTypeContainer](_type,
      "kind",
      _index,
      _owner)
    with KnownField[java.lang.String,_root_.de.ust.skill.sir.SingleBaseTypeContainer] {
    ...
    try {
        target match {
          case c : SimpleChunk ⇒
            ...
            val high = i + c.count
            while (i != high) {
              d(i).asInstanceOf[_root_.de.ust.skill.sir.SingleBaseTypeContainer].Internal_kind = t.read(in).asInstanceOf[java.lang.String]
              i += 1
            }
          case bci : BulkChunk ⇒
  ...
  def offset: Unit = {
    ...
    dataChunks.last match {
      case c : SimpleChunk ⇒
        ...
        val high = i + c.count
        while (i != high) {
          val v = data(i).asInstanceOf[_root_.de.ust.skill.sir.SingleBaseTypeContainer].Internal_kind
          result += t.offset(v)
          i += 1
        }
      case bci : BulkChunk ⇒
  ...
  //override def get(i : _root_.de.ust.skill.sir.SingleBaseTypeContainer) = i.kind
  //override def set(i : _root_.de.ust.skill.sir.SingleBaseTypeContainer, v : java.lang.String) = i.kind = v.asInstanceOf[java.lang.String]

  // note: reflective field access will raise exception for ignored fields
  override def getR(i : SkillObject) : java.lang.String = i.asInstanceOf[_root_.de.ust.skill.sir.SingleBaseTypeContainer].kind
  override def setR(i : SkillObject, v : java.lang.String) : Unit = i.asInstanceOf[_root_.de.ust.skill.sir.SingleBaseTypeContainer].kind = v.asInstanceOf[java.lang.String]
}
