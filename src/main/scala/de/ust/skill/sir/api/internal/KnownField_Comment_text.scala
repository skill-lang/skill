 ...
 * string[] Comment.text
 */
final class KnownField_Comment_text(
  _index : Int,
  _owner : CommentPool,
  _type : FieldType[scala.collection.mutable.ArrayBuffer[java.lang.String]])
    extends FieldDeclaration[scala.collection.mutable.ArrayBuffer[java.lang.String],_root_.de.ust.skill.sir.Comment](_type,
      "text",
      _index,
      _owner)
    with KnownField[scala.collection.mutable.ArrayBuffer[java.lang.String],_root_.de.ust.skill.sir.Comment] {
    ...
    try {
        target match {
          case c : SimpleChunk ⇒
            ...
            val high = i + c.count
            while (i != high) {
              d(i).asInstanceOf[_root_.de.ust.skill.sir.Comment].Internal_text = t.read(in).asInstanceOf[scala.collection.mutable.ArrayBuffer[java.lang.String]]
              i += 1
            }
          case bci : BulkChunk ⇒
  ...
  def offset: Unit = {
    ...
    dataChunks.last match {
      case c : SimpleChunk ⇒
        ...
        val high = i + c.count
        while (i != high) {
          val v = data(i).asInstanceOf[_root_.de.ust.skill.sir.Comment].Internal_text
  ...
  //override def get(i : _root_.de.ust.skill.sir.Comment) = i.text
  //override def set(i : _root_.de.ust.skill.sir.Comment, v : scala.collection.mutable.ArrayBuffer[java.lang.String]) = i.text = v.asInstanceOf[scala.collection.mutable.ArrayBuffer[java.lang.String]]

  // note: reflective field access will raise exception for ignored fields
  override def getR(i : SkillObject) : scala.collection.mutable.ArrayBuffer[java.lang.String] = i.asInstanceOf[_root_.de.ust.skill.sir.Comment].text
  override def setR(i : SkillObject, v : scala.collection.mutable.ArrayBuffer[java.lang.String]) : Unit = i.asInstanceOf[_root_.de.ust.skill.sir.Comment].text = v.asInstanceOf[scala.collection.mutable.ArrayBuffer[java.lang.String]]
}
