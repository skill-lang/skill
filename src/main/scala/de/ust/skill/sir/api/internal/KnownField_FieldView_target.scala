...
final class KnownField_FieldView_target(
  ...
  override def setR(i : SkillObject, v : _root_.de.ust.skill.sir.FieldLike) {
    i.asInstanceOf[_root_.de.ust.skill.sir.FieldView].target = v.asInstanceOf[_root_.de.ust.skill.sir.FieldLike]
  }
}
