...
final class KnownField_EnumType_instances(
  ...
  override def setR(i : SkillObject, v : scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Identifier]) {
    i.asInstanceOf[_root_.de.ust.skill.sir.EnumType].instances = v.asInstanceOf[scala.collection.mutable.ArrayBuffer[_root_.de.ust.skill.sir.Identifier]]
  }
}
