 ...
 */
final class F_Identifier_skillname(
  _index : Int,
  _owner : IdentifierPool,
  _type : FieldType[java.lang.String])
    extends FieldDeclaration[java.lang.String,_root_.de.ust.skill.sir.Identifier](_type,
      "skillname",
      _index,
      _owner)
    with KnownField[java.lang.String,_root_.de.ust.skill.sir.Identifier] {
  ...
  override def setR(i : SkillObject, v : java.lang.String) {
    i.asInstanceOf[_root_.de.ust.skill.sir.Identifier].skillname = v.asInstanceOf[java.lang.String]
  }
}
