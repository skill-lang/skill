...
In contrast to our approach, XML requires the serialized data to form a tree. This, however, is not a real problem, because there is at least one canonical transformation, which turns a graph into a tree (by adding a node and some attributes).
