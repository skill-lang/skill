...
\node [root concept]{All Types}[clockwise from=-60] % root
...
\todo{Hier MUSS noch eine Ordnung bezüglich Typen rein, die vor der lexikalischen Ordnnug stattfindet, sonst kann es sein, dass ein size feld erst nach dem betroffenen array liegt und dann ist die deserialisierung unmöglich}
