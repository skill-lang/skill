...
\todo{string in *unique string* o.ä. umbenennen, um verwirrung bei C Programmierern vorzubeugen}

% main parts of the document
\include{parts/motivation}
\include{parts/syntax}
\include{parts/semantics}
\include{parts/extensions}
\include{parts/normalform}
\include{parts/serialization}
\include{parts/api}
