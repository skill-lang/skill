...
\todo{explain that using annotation objects of unknown type will result in a runtime error}
...
\todo{ das ist viel zu kompliziert und zu verwirrend und vor allem quasi unnötig, da echt viel von der grammatik abgedeckt wird} 
...
\todo{i1 muss kleiner sein als alles andere, damit man bitstrings zusammenpacken kann}
\begin{itemize}
...
\todo{create a figure out of this with a nice frame and caption}
